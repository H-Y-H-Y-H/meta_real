...
class LX16A:
  ...
  # need to add exception and retry in case if checksum is not good
  # also check correct ID and command in return
...
#     print(r_packet)
  ...
  # Move the servo between 0 and 1000 or 0.24 degree resolution
  ...
  # angle is between 0 and 1000 siot 0.24 degree of resolution
  # rate is in ms from 0(fast) to 30000(slow)
  ...
  # Move the servo between 0 and 1000 or 0.24 degree resolution
  # rate is in ms from 0(fast) to 30000(slow)
  # **** Wait for SERVO_MOVE_STOP command
  ...
  # Read angle and rate sent by moveServoWait
  # angle is between 0 and 1000 siot 0.24 degree of resolution
  # rate is in ms from 0(fast) to 30000(slow)
